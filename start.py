...
def main():
    ...
    if start_mode == "master":
        droidmaster = DroidMaster(
            ...
            without_taxonomy=opts.without_taxonomy,
            without_rule=opts.without_rule,
            without_llm=opts.without_llm,
            without_next_screen_summary=opts.without_next_screen_summary,
            without_history_summary=opts.without_history_summary
            )
        droidmaster.start()
    else:
        droidbot = DroidBot(
