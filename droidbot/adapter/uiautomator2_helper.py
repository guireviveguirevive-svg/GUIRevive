...
class Uiautomator2_Helper:
    def __init__(self, device=None, package_name = None):
        ...
        # Global variables for instance counting
        self.classname_list = []
    ...
    def get_instance(self, view_dict):
        """
        Assign instance ID to a view.
        Count based on the combination of className and resourceId.
        """
    ...
    def select_target_root_node(self, xml):
        ...
        Because the xml file dumped by uiautomator may contain multiple root nodes, we need to select the root node we care about
        :param xml: the xml
