...
class DroidBot(object):
    ...
    def __init__(self,
                 ...
                 without_taxonomy=False,
                 without_rule=False,
                 without_llm=False,
                 without_next_screen_summary=False,
                 without_history_summary=False):
        """
        ...
        try:
            ...
            self.input_manager = InputManager(
                ...
                without_next_screen_summary=without_next_screen_summary,
                without_history_summary=without_history_summary)
        except Exception:
            import traceback
            traceback.print_exc()
            self.stop()
